                ...
                <Form>
                    <div className="mt-2 pb-4 border-b border-red-950">
                        ...
                        <div className="flex flex-row gap-x-4 mt-3 ml-1">
                            <label className="w-7 h-7 border-2 border-gray-900 selection:border-yellow-400 bg-black">
                                <Field
                                    type="radio"
                                    name="color"
                                    value="black"
                            ...
                            <label className="w-7 h-7 border-2 border-gray-900 selection:border-yellow-400 bg-white">
                                <Field
                                    type="radio"
                                    name="color"
                                    value="white"
                            ...
                            <label className="w-7 h-7 border-2 border-gray-900 selection:border-yellow-400 bg-orange-950">
                                <Field
                                    type="radio"
                                    name="color"
                                    value="brown"
                    ...
                    <div className="mt-2">
                        ...
                        >
                            ...
                            <option value="sixthfloor">Transfer to the 6th floor and above</option>
                        </Field>
                    </div>
